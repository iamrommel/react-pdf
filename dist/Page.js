  ...
  function Page() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Page.__proto__ || (0, _getPrototypeOf2.default)(Page)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ page: page }, function () {
        ...
        (0, _utils.callIfDefined)(_this.props.registerPage, page.pageIndex, _this.ref);
      });
  ...
  (0, _createClass3.default)(Page, [{
    ...
    value: function componentWillReceiveProps(nextProps, nextContext) {
      if (nextContext.pdf !== this.context.pdf || this.getPageNumber(nextProps) !== this.getPageNumber()) {
        (0, _utils.callIfDefined)(this.props.unregisterPage, this.pageIndex);
    ...
    get: function get() {
      ...
      return (0, _events.makeEventProps)(this.props, function () {
        ...
        return (0, _utils.makePageCallback)(page, scale);
      });
    }
  }, {
    key: 'pageKey',
